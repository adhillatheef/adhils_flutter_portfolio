      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            size.isDesktop? GridView.builder(
              shrinkWrap: true,
              ...
              children: experiences.map((e) {
                int index = experiences.indexWhere((element) => element == e);
                return Padding(
...
class ExperienceContainer extends StatelessWidget {
  ...
  const ExperienceContainer({
    super.key, required this.experienceInfo, required this.color,
  });
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children:  [
            Text(experienceInfo.position, style: Theme.of(context).textTheme.headlineMedium?.copyWith(color: Colors.black),),
            Text(experienceInfo.company, style: Theme.of(context).textTheme.headlineSmall?.copyWith(color: Colors.black)),
            const SizedBox(height: 20,),
            Text(experienceInfo.timeLine),
            const SizedBox(height: 20,),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: experienceInfo.description.map((e) => Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text(
                    '\u2022',
