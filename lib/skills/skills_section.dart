...
class SkillsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ResponsiveBuilder(builder: (_, size) {
      return  SkillsDesktopView(size: size,);
    });
  }
}
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          if(size.isMobile) const Divider(thickness: 3,),
          Text(
            'Skills',
...
class OutlineSkillsContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Text(
          skills.elementAt(index),
          style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontSize: size.isMobile? 24: null),
        ));
  }
}
